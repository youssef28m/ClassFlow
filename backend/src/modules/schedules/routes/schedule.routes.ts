...
import { createScheduleSchema, listSchedulesQuerySchema, updateScheduleSchema } from '../validation/schedule.validation.js';
...
router.get('/', requirePermission('groupsAndSessions', 'read'), validateQuery(listSchedulesQuerySchema), controller.list);
...
router.delete('/:id', requirePermission('groupsAndSessions', 'manageSchedules'), requireResolvedCenterId, controller.delete);
