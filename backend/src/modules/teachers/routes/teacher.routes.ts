...
import { createTeacherSchema, listTeachersQuerySchema, updateTeacherSchema } from '../validation/teacher.validation.js';
...
router.delete('/:id', requirePermission('teachersAndSalaries', 'deleteTeacher'), requireResolvedCenterId, controller.delete);
